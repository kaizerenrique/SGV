...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('saluds', function (Blueprint $table) {
            ...
            $table->boolean('gestacion')->nullable();
            $table->boolean('esterilizacion')->nullable();
            $table->boolean('enfermedadcronica')->nullable();
            $table->boolean('atencionmedica')->nullable();
            $table->boolean('quirurgica')->nullable();
            $table->string('tipoquirurgica')->nullable();
            $table->timestamps();
        });
    }
