                ...
                if ($info1 == false) {
                    ...
                    if (!empty($fecha_nacimiento)) {                
                        ...
                        $info = [
                            ...
                            'cne' => [
                                'inscrito' => $info1['inscrito'],
                                'cvestado' =>  $info1['cvestado'] ?? null,
                                'cvmunicipio' =>  $info1['cvmunicipio'] ?? null,
                                'cvparroquia' =>  $info1['cvparroquia'] ?? null,
                                'centro' =>  $info1['centro'] ?? null,
                                'direccion' =>  $info1['direccion'] ?? null,
                            ]
                        ];
                    }
                }
